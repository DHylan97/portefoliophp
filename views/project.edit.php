<div class="container">
    ...
    <form action="/project/<?= $project->id ?>/updateProject" method="post" enctype="multipart/form-data">
        <div class="row mb-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" name="category_id">
                    ...
                    foreach ($categories as $category): ?>
                        <option <?php if ($project->category_id === $category['id'])
                            echo 'selected' ?>
            ...
            <?php foreach ($project->images() as $image): ?>
                <div class="col-2">
                    <div class="img-wrapper">
                        <a href="/image/<?= $image->id ?>/deleteImage" class="btn btn-sm btn-danger btn-image">
                            <i class="fa fa-times"></i>
                        </a>
                        <img src="<?= $image->path ?>" alt="<?= $image->path ?>" class="img-fluid">
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
