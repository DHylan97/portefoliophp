...
$router->map( 'GET', '/aboutme', [BaseController::class, 'aboutme'], 'aboutme' );

$router->map( 'GET', '/skills', [SkillsController::class, 'skills'], 'skills' );

$router->map( 'GET', '/contact', [ContactController::class, 'contact'], 'contact' );
...
$router->map( 'POST', '/project/[i:id]/updateProject', [ProjectController::class, 'updateProject'], 'project.update' );
$router->map( 'GET', '/project/[i:id]/deleteProject', [ProjectController::class, 'deleteProject'], 'project.delete' );

$router->map( 'GET', '/image/[i:id]/deleteImage', [ImageController::class, 'deleteImage'], 'image.delete' );
